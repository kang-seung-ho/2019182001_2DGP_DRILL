...
class WalkingState:
    ...
    def do(boy):
        ...
        #캐릭터가 월드를 벗어나지 못하도록 조정
        boy.x = clamp(0, boy.x, server.background.w - 1 - 50)
        boy.y = clamp(0, boy.y, server.background.h - 1 - 50)
    ...
    def draw(boy):
        ...
        boy.font.draw(sx - 60, sy + 50, f'({game_world.ball_cnt})', (255, 255, 0))
